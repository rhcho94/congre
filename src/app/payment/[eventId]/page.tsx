...
제작 기간: 결제가 완료되면 즉시 편집이 시작되며 통상 10분 이내에 완성됩니다.
회사의 사유로 지연될 경우 결제 완료 시각을 기준으로 4시간을 초과하면 결제 금액의
50%, 48시간을 초과하면 100%가 환불 확정되며, 확정일부터 영업일 기준 3일 이내에
처리됩니다.

다운로드 기간: 완성본은 완성된 시점으로부터 약 7일간 다운로드할 수 있습니다.
이후 자동 삭제되며 복구할 수 없습니다.`}
              </p>
            </div>
