        ...
        <main className="mx-auto max-w-3xl px-6 py-16">
          ...
          <section className="flex flex-col gap-4">
            ...
            <article className="flex flex-col gap-2">
              ...
              <p>⑤ 제①항 제1호에도 불구하고, 회사의 사유로 완성본 영상의 제작이 지연되거나 실패한 이벤트의 클립은 완성본 제공을 위한 목적에 한하여 결제 완료 시점으로부터 최대 7일까지 보존될 수 있습니다. 위 기간이 경과하면 예외 없이 삭제되며, 삭제 이후 완성본 영상의 제공 및 재제작은 불가능합니다.</p>
            </article>
