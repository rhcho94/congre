      ...
      <div className="min-h-screen">
        ...
        <main className="mx-auto max-w-3xl px-6 py-16">
          ...
          <section className="flex flex-col gap-4">
            ...
            <article className="flex flex-col gap-2">
              <h3 className="text-sm font-medium text-foreground">제10조 (유료 서비스 및 요금)</h3>
              <p>① 회사는 무료 플랜과 유료 플랜으로 서비스를 제공하며, 회원은 이벤트 생성 시 플랜을 선택합니다. 플랜은 이벤트 생성 후 변경할 수 없습니다.</p>
              <p>② 무료 플랜에는 다음 각 호의 사항이 적용됩니다.</p>
              <ol className="list-decimal pl-6 flex flex-col gap-1">
                <li>일정 수준의 가용성을 보장하지 아니합니다.</li>
                <li>서비스 수준 협약(SLA)이 적용되지 아니합니다.</li>
                <li>사전 고지 없이 기능이 변경·중단될 수 있습니다.</li>
                <li>완성본 영상에 회사의 식별 표시가 삽입됩니다.</li>
              </ol>
              <p>③ 회사는 무료 플랜의 이용으로 인하여 회원에게 발생한 손해에 대하여 회사의 고의 또는 중대한 과실이 없는 한 책임을 지지 아니합니다.</p>
              <p>④ 유료 플랜의 요금은 이벤트 마감 시점에 실제로 업로드된 클립을 기준으로 다음과 같이 산정합니다.</p>
              <ol className="list-decimal pl-6 flex flex-col gap-1">
                <li>요금 = 호스트가 설정한 클립 최대 길이(초) × 마감 시점의 업로드 클립 수 × 100원</li>
                <li>제1호에 따라 산정한 금액이 10,000원 미만인 경우 10,000원을 최소 요금으로 합니다.</li>
              </ol>
              <p>⑤ 이벤트 생성 화면에 표시되는 금액은 설정한 정원이 모두 채워졌을 경우의 최대 금액이며, 실제 결제 금액은 마감 시점에 확정됩니다.</p>
              <p>⑥ 회사는 요금 체계를 변경할 수 있으며, 변경 시 제3조에 따라 사전 공지합니다. 변경 전에 생성된 이벤트에는 생성 시점의 요금 체계가 적용됩니다.</p>
            </article>

            <article className="flex flex-col gap-2">
              <h3 className="text-sm font-medium text-foreground">제10조의2 (결제)</h3>
              <p>① 유료 플랜의 결제는 호스트가 이벤트를 마감하는 시점에 이루어지며, 결제가 완료되면 즉시 완성본 영상의 제작이 개시됩니다.</p>
              <p>② 결제 수단은 신용카드·체크카드 등 회사가 정하여 결제 화면에 표시한 수단으로 합니다.</p>
              <p>③ 회사는 결제대행 업무를 토스페이먼츠 주식회사에 위탁합니다. 회원의 카드번호 등 결제수단의 상세 정보는 결제대행사가 수집·보관하며 회사는 이를 보관하지 아니합니다.</p>
              <p>④ 회사는 결제가 진행되기 전에 제10조의3에 따른 청약철회 제한 사항을 회원이 명확히 확인할 수 있도록 고지하며, 회원의 확인 절차를 거친 후 결제를 진행합니다.</p>
              <p>⑤ 결제와 관련하여 회사가 처리하는 개인정보의 항목과 보유 기간은 「Congre 개인정보처리방침」에서 정합니다.</p>
            </article>

            <article className="flex flex-col gap-2">
              <h3 className="text-sm font-medium text-foreground">제10조의3 (청약철회 및 환불)</h3>
              <p>① 유료 플랜은 결제 완료와 동시에 완성본 영상의 제작이 개시되는 디지털 콘텐츠로서, 「전자상거래 등에서의 소비자보호에 관한 법률」이 정하는 바에 따라 제작이 개시된 이후에는 회원의 단순 변심을 이유로 한 청약철회가 제한됩니다.</p>
              <p>② 회사는 제①항의 제한을 적용하기 위하여 결제 진행 전에 해당 사실을 회원이 명확히 확인할 수 있도록 고지합니다. 또한 회원은 유료 결제 이전에 무료 플랜을 통하여 서비스의 결과물을 사전에 확인할 수 있습니다.</p>
              <p>③ 회사의 사유로 완성본 영상의 제공이 지연된 경우, 결제 완료 시각을 기준으로 다음 각 호에 따라 환불합니다.</p>
              <ol className="list-decimal pl-6 flex flex-col gap-1">
                <li>4시간 이내에 제공된 경우: 환불하지 아니합니다.</li>
                <li>4시간을 초과하고 48시간 이내에 제공된 경우: 결제 금액의 50%를 환불합니다.</li>
                <li>48시간을 초과한 경우: 결제 금액의 100%를 환불합니다. 이 경우 환불 여부와 관계없이 회사는 제11조 제⑤항이 정하는 기간 내에서 완성본 영상의 제공을 계속 시도합니다.</li>
              </ol>
              <p>④ 회사의 사유로 완성본 영상을 제공할 수 없게 된 경우, 회사는 결제 금액의 100%를 환불합니다.</p>
              <p>⑤ 제11조 제⑤항이 정하는 보존 기간이 경과하여 클립이 삭제된 경우 완성본 영상의 제공 및 재제작은 불가능합니다. 이 경우에도 제③항 제3호 또는 제④항에 따른 환불은 이루어집니다.</p>
              <p>⑥ 다음 각 호의 사유로 인한 지연 또는 제공 불능은 회사의 사유로 보지 아니하며, 환불 사유에 해당하지 아니합니다.</p>
              <ol className="list-decimal pl-6 flex flex-col gap-1">
                <li>회원 또는 참가자가 업로드한 영상 파일의 손상, 형식 부적합, 재생 불가</li>
                <li>마감 시점에 업로드된 클립이 없는 경우</li>
                <li>제20조 제②항 각 호에 해당하는 사유</li>
              </ol>
              <p>⑦ 완성본 영상의 편집 결과, 연출, 배경음악, 색감 등에 대한 회원의 주관적 불만은 환불 사유에 해당하지 아니합니다. 다만 회사는 제14조에 따른 재렌더를 제공합니다.</p>
              <p>⑧ 환불은 회원이 결제한 수단과 동일한 수단으로 하며, 환불 사유가 확정된 날부터 영업일 기준 3일 이내에 처리합니다. 다만 결제수단 사업자의 사정에 따라 실제 입금까지 추가 기간이 소요될 수 있습니다.</p>
            </article>
          </section>
          ...
          <section className="flex flex-col gap-4">
            ...
            <article className="flex flex-col gap-2">
              ...
              <ol className="list-decimal pl-6 flex flex-col gap-1">
                <li><strong className="text-foreground">클립</strong>: 참가자 결과 알림이 발송된 시점으로부터 약 48시간 후 자동 삭제</li>
              ...
              <p>⑤ 제①항 제1호에도 불구하고, 회사의 사유로 완성본 영상의 제작이 지연되거나 실패한 이벤트의 클립은 완성본 제공을 위한 목적에 한하여 결제 완료 시점(무료 플랜의 경우 이벤트 마감 시점)으로부터 최대 7일까지 보존될 수 있습니다. 위 기간이 경과하면 예외 없이 삭제되며, 삭제 이후 완성본 영상의 제공 및 재제작은 불가능합니다.</p>
            </article>
            ...
            <article className="flex flex-col gap-2">
              ...
              <p>② 재렌더 시 이전에 생성된 완성본 영상은 새로운 완성본으로 대체되며 복구되지 아니할 수 있습니다.</p>
              <p>③ 유료 플랜의 재렌더에는 별도의 요금 또는 횟수 제한이 적용될 수 있으며, 요금이 부과되는 경우 회사는 재렌더 요청 전에 이를 고지하고 회원의 확인을 거칩니다.</p>
              <p>④ 재렌더는 제11조에 따라 클립이 보존되어 있는 기간 내에서만 가능합니다.</p>
            </article>
          </section>
          ...
          <section className="flex flex-col gap-4">
            ...
            <article className="flex flex-col gap-2">
              ...
              <ol className="list-decimal pl-6 flex flex-col gap-1">
                ...
                <li>영상의 자동 삭제 기간(클립 약 48시간, 완성본 약 7일)</li>
                <li>완성본 영상의 공유 범위</li>
          ...
          <section className="flex flex-col gap-4">
            ...
            <article className="flex flex-col gap-2">
              ...
              <p>① 회사는 무료 플랜으로 제공되는 서비스와 관련하여 회원 또는 제3자에게 발생한 손해에 대하여 회사의 고의 또는 중대한 과실이 없는 한 책임을 지지 아니합니다.</p>
              ...
              <p>④ 유료 플랜과 관련하여 회사가 부담하는 손해배상액은 회사의 고의 또는 중대한 과실이 있는 경우를 제외하고, 해당 이벤트에 대하여 회원이 실제로 결제한 금액을 한도로 합니다.</p>
            </article>
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>통신판매업신고번호: 신고 면제 대상 (전자상거래법 제12조 제1항 단서)</p>
