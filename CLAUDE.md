...
- **catch 블록 console.error 의무**: 사용자에 에러 메시지 표시하는 모든 catch 블록에 `console.error("[context] failed:", err)` 의무. Vercel·브라우저 서버 로그가 유일한 원격 디버깅 채널. 누락 시 진단 1단계로 console.error 추가가 첫 번째 정정 작업이 됨 (Shotstack 2026-05-08 결정 / 가입 흐름 2026-05-19 v2 사고 #3와 일관성).
