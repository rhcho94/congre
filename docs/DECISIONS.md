...
- [rendering](decisions/rendering.md) — 영상 편집·Shotstack·클립 (38개)
...
- [market-product](decisions/market-product.md) — 시장 정의·BM·서비스 모델 (14개)
...
- [landing](decisions/landing.md) — 랜딩 페이지 디자인·자산·배포 (17개)
