...
- [rendering](decisions/rendering.md) — 영상 편집·Shotstack·클립 (36개)
...
- [data-flow](decisions/data-flow.md) — Firestore·S3·Admin SDK·서버 이전 (16개)
- [landing](decisions/landing.md) — 랜딩 페이지 디자인·자산·배포 (16개)
