...
- [rendering](decisions/rendering.md) — 영상 편집·Shotstack·클립 (30개)
...
- [market-product](decisions/market-product.md) — 시장 정의·BM·서비스 모델 (13개)
- [infra](decisions/infra.md) — Vercel·Firebase·도메인·무료 티어 정책 (5개)
- [data-flow](decisions/data-flow.md) — Firestore·S3·Admin SDK·서버 이전 (13개)
- [landing](decisions/landing.md) — 랜딩 페이지 디자인·자산·배포 (15개)
- [misc](decisions/misc.md) — 영역 외 결정 (4개)
